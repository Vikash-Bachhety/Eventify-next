...
export default function Home() {
    return (
        <>
            ...
            <section className="w-full py-16 bg-black text-white flex flex-col items-center min-h-96">
                ...
                <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
                    {/* Testimonial 1 */}
                    <div className="w-96 p-6 bg-gray-800 rounded-lg shadow-lg hover:skew-y-6 hover:scale-105 duration-300">
            ...
            <section className="py-16 bg-gradient-to-r from-teal-500 to-sky-500 w-full flex flex-col justify-center items-center">
                ...
                <div className="mt-8 space-y-6 w-1/3">
