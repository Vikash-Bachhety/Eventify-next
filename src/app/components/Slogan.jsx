...
export default function Slogan() {
  return (
    <section className="py-10 bg-gradient-to-r from-teal-500 to-sky-400 text-white text-center">
      ...
      <div className="flex space-x-5 justify-evenly mt-20">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/CWQdO3S_bVA?si=D8Pr2TCMH-HvZZ3Y" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
        <iframe width="560" height="315" src="https://www.youtube.com/embed/ECTheIF2Gv4?si=WziiwrE3L_iTAIWS" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
      </div>
    </section>
  );
}
